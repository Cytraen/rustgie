...
impl RustgieClient {
    ...
    async fn bungie_api_post<T: serde::de::DeserializeOwned>(&self, url: reqwest::Url) -> T {
    ...
    async fn bungie_api_post_with_body<T: serde::de::DeserializeOwned, U: serde::Serialize>(&self, url: reqwest::Url, request_body: U) -> T {
        self.client.post(url)
            .json(&request_body)
            .send()
            .await
    ...
    pub async fn destiny2_awa_initialize_request(&self, request_body: rustgie_types::destiny::advanced::AwaPermissionRequested) -> rustgie_types::destiny::advanced::AwaInitializeResponse {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Awa/Initialize/").unwrap(), request_body).await
    }

    pub async fn destiny2_awa_provide_authorization_result(&self, request_body: rustgie_types::destiny::advanced::AwaUserResponse) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Awa/AwaProvideAuthorizationResult/").unwrap(), request_body).await
    }

    pub async fn destiny2_equip_item(&self, request_body: rustgie_types::destiny::requests::actions::DestinyItemActionRequest) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/EquipItem/").unwrap(), request_body).await
    }

    pub async fn destiny2_equip_items(&self, request_body: rustgie_types::destiny::requests::actions::DestinyItemSetActionRequest) -> rustgie_types::destiny::DestinyEquipItemResults {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/EquipItems/").unwrap(), request_body).await
    }
    ...
    pub async fn destiny2_insert_socket_plug(&self, request_body: rustgie_types::destiny::requests::actions::DestinyInsertPlugsActionRequest) -> rustgie_types::destiny::responses::DestinyItemChangeResponse {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/InsertSocketPlug/").unwrap(), request_body).await
    }

    pub async fn destiny2_insert_socket_plug_free(&self, request_body: rustgie_types::destiny::requests::actions::DestinyInsertPlugsFreeActionRequest) -> rustgie_types::destiny::responses::DestinyItemChangeResponse {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/InsertSocketPlugFree/").unwrap(), request_body).await
    }

    pub async fn destiny2_pull_from_postmaster(&self, request_body: rustgie_types::destiny::requests::actions::DestinyPostmasterTransferRequest) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/PullFromPostmaster/").unwrap(), request_body).await
    }

    pub async fn destiny2_report_offensive_post_game_carnage_report_player(&self, activity_id: i64, request_body: rustgie_types::destiny::reporting::requests::DestinyReportOffensePgcrRequest) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Destiny2/Stats/PostGameCarnageReport/{activity_id}/Report/")).unwrap(), request_body).await
    }
    ...
    pub async fn destiny2_search_destiny_player_by_bungie_name(&self, membership_type: rustgie_types::BungieMembershipType, request_body: rustgie_types::user::ExactSearchRequest) -> Vec<rustgie_types::user::UserInfoCard> {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Destiny2/SearchDestinyPlayerByBungieName/{membership_type}/")).unwrap(), request_body).await
    }

    pub async fn destiny2_set_item_lock_state(&self, request_body: rustgie_types::destiny::requests::actions::DestinyItemStateRequest) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/SetLockState/").unwrap(), request_body).await
    }

    pub async fn destiny2_set_quest_tracked_state(&self, request_body: rustgie_types::destiny::requests::actions::DestinyItemStateRequest) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/SetTrackedState/").unwrap(), request_body).await
    }

    pub async fn destiny2_transfer_item(&self, request_body: rustgie_types::destiny::requests::DestinyItemTransferRequest) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Destiny2/Actions/Items/TransferItem/").unwrap(), request_body).await
    }
    ...
    pub async fn forum_get_recruitment_thread_summaries(&self, request_body: Vec<i64>) -> Vec<rustgie_types::forum::ForumRecruitmentDetail> {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Forum/Recruit/Summaries/").unwrap(), request_body).await
    }
    ...
    pub async fn group_v2_abdicate_foundership(&self, founder_id_new: i64, group_id: i64, membership_type: rustgie_types::BungieMembershipType) -> bool {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Admin/AbdicateFoundership/{membership_type}/{founder_id_new}/")).unwrap()).await
    }

    pub async fn group_v2_add_optional_conversation(&self, group_id: i64, request_body: rustgie_types::groups_v2::GroupOptionalConversationAddRequest) -> i64 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/OptionalConversations/Add/")).unwrap(), request_body).await
    }

    pub async fn group_v2_approve_all_pending(&self, group_id: i64, request_body: rustgie_types::groups_v2::GroupApplicationRequest) -> Vec<rustgie_types::entities::EntityActionResult> {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/ApproveAll/")).unwrap(), request_body).await
    }

    pub async fn group_v2_approve_pending(&self, group_id: i64, membership_id: i64, membership_type: rustgie_types::BungieMembershipType, request_body: rustgie_types::groups_v2::GroupApplicationRequest) -> bool {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/Approve/{membership_type}/{membership_id}/")).unwrap(), request_body).await
    }

    pub async fn group_v2_approve_pending_for_list(&self, group_id: i64, request_body: rustgie_types::groups_v2::GroupApplicationListRequest) -> Vec<rustgie_types::entities::EntityActionResult> {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/ApproveList/")).unwrap(), request_body).await
    }

    pub async fn group_v2_ban_member(&self, group_id: i64, membership_id: i64, membership_type: rustgie_types::BungieMembershipType, request_body: rustgie_types::groups_v2::GroupBanRequest) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/{membership_type}/{membership_id}/Ban/")).unwrap(), request_body).await
    }

    pub async fn group_v2_deny_all_pending(&self, group_id: i64, request_body: rustgie_types::groups_v2::GroupApplicationRequest) -> Vec<rustgie_types::entities::EntityActionResult> {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/DenyAll/")).unwrap(), request_body).await
    }

    pub async fn group_v2_deny_pending_for_list(&self, group_id: i64, request_body: rustgie_types::groups_v2::GroupApplicationListRequest) -> Vec<rustgie_types::entities::EntityActionResult> {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/DenyList/")).unwrap(), request_body).await
    }

    pub async fn group_v2_edit_clan_banner(&self, group_id: i64, request_body: rustgie_types::groups_v2::ClanBanner) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/EditClanBanner/")).unwrap(), request_body).await
    }

    pub async fn group_v2_edit_founder_options(&self, group_id: i64, request_body: rustgie_types::groups_v2::GroupOptionsEditAction) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/EditFounderOptions/")).unwrap(), request_body).await
    }

    pub async fn group_v2_edit_group(&self, group_id: i64, request_body: rustgie_types::groups_v2::GroupEditAction) -> i32 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Edit/")).unwrap(), request_body).await
    }

    pub async fn group_v2_edit_group_membership(&self, group_id: i64, membership_id: i64, membership_type: rustgie_types::BungieMembershipType, member_type: rustgie_types::groups_v2::RuntimeGroupMemberType) -> i32 {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/{membership_type}/{membership_id}/SetMembershipType/{member_type}/")).unwrap()).await
    }

    pub async fn group_v2_edit_optional_conversation(&self, conversation_id: i64, group_id: i64, request_body: rustgie_types::groups_v2::GroupOptionalConversationEditRequest) -> i64 {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/OptionalConversations/Edit/{conversation_id}/")).unwrap(), request_body).await
    }
    ...
    pub async fn group_v2_get_group_by_name_v2(&self, request_body: rustgie_types::groups_v2::GroupNameSearchRequest) -> rustgie_types::groups_v2::GroupResponse {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/GroupV2/NameV2/").unwrap(), request_body).await
    }
    ...
    pub async fn group_v2_get_recommended_groups(&self, create_date_range: rustgie_types::groups_v2::GroupDateRange, group_type: rustgie_types::groups_v2::GroupType) -> Vec<rustgie_types::groups_v2::GroupV2Card> {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/Recommended/{group_type}/{create_date_range}/")).unwrap()).await
    }
    ...
    pub async fn group_v2_group_search(&self, request_body: rustgie_types::groups_v2::GroupQuery) -> rustgie_types::groups_v2::GroupSearchResponse {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/GroupV2/Search/").unwrap(), request_body).await
    }

    pub async fn group_v2_individual_group_invite(&self, group_id: i64, membership_id: i64, membership_type: rustgie_types::BungieMembershipType, request_body: rustgie_types::groups_v2::GroupApplicationRequest) -> rustgie_types::groups_v2::GroupApplicationResponse {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/IndividualInvite/{membership_type}/{membership_id}/")).unwrap(), request_body).await
    }

    pub async fn group_v2_individual_group_invite_cancel(&self, group_id: i64, membership_id: i64, membership_type: rustgie_types::BungieMembershipType) -> rustgie_types::groups_v2::GroupApplicationResponse {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/IndividualInviteCancel/{membership_type}/{membership_id}/")).unwrap()).await
    }

    pub async fn group_v2_kick_member(&self, group_id: i64, membership_id: i64, membership_type: rustgie_types::BungieMembershipType) -> rustgie_types::groups_v2::GroupMemberLeaveResult {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/{membership_type}/{membership_id}/Kick/")).unwrap()).await
    }
    ...
    pub async fn group_v2_unban_member(&self, group_id: i64, membership_id: i64, membership_type: rustgie_types::BungieMembershipType) -> i32 {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/GroupV2/{group_id}/Members/{membership_type}/{membership_id}/Unban/")).unwrap()).await
    }

    pub async fn social_accept_friend_request(&self, membership_id: String) -> bool {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Social/Friends/Requests/Accept/{membership_id}/")).unwrap()).await
    }

    pub async fn social_decline_friend_request(&self, membership_id: String) -> bool {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Social/Friends/Requests/Decline/{membership_id}/")).unwrap()).await
    }
    ...
    pub async fn social_issue_friend_request(&self, membership_id: String) -> bool {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Social/Friends/Add/{membership_id}/")).unwrap()).await
    }

    pub async fn social_remove_friend(&self, membership_id: String) -> bool {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Social/Friends/Remove/{membership_id}/")).unwrap()).await
    }

    pub async fn social_remove_friend_request(&self, membership_id: String) -> bool {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Social/Friends/Requests/Remove/{membership_id}/")).unwrap()).await
    }

    pub async fn tokens_apply_missing_partner_offers_without_claim(&self, partner_application_id: i32, target_bnet_membership_id: i64) -> bool {
        RustgieClient::bungie_api_post(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/Tokens/Partner/ApplyMissingOffers/{partner_application_id}/{target_bnet_membership_id}/")).unwrap()).await
    }

    pub async fn tokens_claim_partner_offer(&self, request_body: rustgie_types::tokens::PartnerOfferClaimRequest) -> bool {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse("https://www.bungie.net/Platform/Tokens/Partner/ClaimOffer/").unwrap(), request_body).await
    }
    ...
    pub async fn user_search_by_global_name_post(&self, page: i32, request_body: rustgie_types::user::UserSearchPrefixRequest) -> rustgie_types::user::UserSearchResponse {
        RustgieClient::bungie_api_post_with_body(self, reqwest::Url::parse(&*format!("https://www.bungie.net/Platform/User/Search/GlobalName/{page}/")).unwrap(), request_body).await
    }
